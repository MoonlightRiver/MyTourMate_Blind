# MyTourMate
본 프로젝트는 (Blinded) 수업의 과제 용도로 제작되었습니다.
...
- Software Design Document : Blind 처리된 링크를 포트폴리오에 기재하였습니다.
- Final Presentation : Blind 처리된 링크를 포트폴리오에 기재하였습니다.
...
저희 프로젝트에서 중요하게 쓰이는 Mecab을 이용한 Korean Tokenizer는 (Blinded)이 제작하셨고, 그 위에 (Blinded)님이 수정하여 제공해주셨습니다.
